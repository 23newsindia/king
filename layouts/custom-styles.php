...
background-color:<?php echo get_field( 'body_background', 'option' ); ?>;<?php endif; ?>	
		<?php
...
.owl-prev:hover, 
.owl-next:hover {
	color:<?php echo get_field( 'page_link_hover_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'post_background', 'option' ) ) : ?>
article.hentry {
	background-color:<?php echo get_field( 'post_background', 'option' ); ?>;
}
<?php endif; ?>
...
.king-order-nav ul li a:hover {
	color:<?php echo get_field( 'page_link_color', 'option' ); ?>;
}
.king-order-nav ul li .active:after, 
.king-order-nav ul li a:hover:after {
	border-color: <?php echo get_field( 'page_link_color', 'option' ); ?>;
}
...
article.hentry .entry-meta {
	color:<?php echo get_field( 'posts_meta_color', 'option' ); ?>!important;
}
<?php endif; ?>
<?php if ( get_field( 'posts_meta_background', 'option' ) ) : ?>
article.hentry .entry-meta {
	background-color:<?php echo get_field( 'posts_meta_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'load_more_background', 'option' ) ) : ?>
.ias-trigger-next {
<?php if ( get_field( 'load_more_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'load_more_background', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'load_more_button_text_color', 'option' ) ) : ?>
.ias-trigger a {
<?php if ( get_field( 'load_more_button_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'load_more_button_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
...
<?php if ( get_field( 'button_colors', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'button_colors', 'option' ); ?>;
	border-color:<?php echo get_field( 'button_colors', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'button_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'button_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'follow_button_background', 'option' ) ) : ?>
.user-follow-button a {
	background-color:<?php echo get_field( 'follow_button_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'follow_button_text_color', 'option' ) ) : ?>
.user-follow-button .sl-count, .user-follow-button i {
	color:<?php echo get_field( 'follow_button_text_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'post_entry_content_color', 'option' ) ) : ?>
article .entry-content, .king-profile-sidebar {
	color:<?php echo get_field( 'post_entry_content_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'post_title_color', 'option' ) ) : ?>
article.hentry .entry-title a {
	color:<?php echo get_field( 'post_title_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_nsfw', 'option' ) ) : ?>
.nsfw-post, .nsfw, .nsfw-post-page, .nsfw-post-simple {
	background-color:<?php echo get_field( 'color_for_nsfw', 'option' ); ?>;
}
<?php endif; ?>
/* ------header------ */
...
<?php if ( get_field( 'headerstrip_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'headerstrip_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'headerstrip_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'headerstrip_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
...
<?php if ( get_field( 'headerstrip_button_color', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'headerstrip_button_color', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'headerstrip_background', 'option' ) ) : ?>
	color:<?php echo get_field( 'headerstrip_background', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'headerstrip_button_color', 'option' ) ) : ?>
.king-hs-close {
	color:<?php echo get_field( 'headerstrip_button_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'buttons_hover_background', 'option' ) ) : ?>
.king-login-buttons a:hover {
	background-color:<?php echo get_field( 'buttons_hover_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_background', 'option' ) ) : ?>
.king-header, .king-search-top .active {
	background-color:<?php echo get_field( 'header_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'navigation_background', 'option' ) ) : ?>
.main-navigation, .main-navigation ul ul, .main-navigation ul ul ul {
	background-color:<?php echo get_field( 'navigation_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_menu_background_color', 'option' ) ) : ?>
.king-cat-list {
	background-color:<?php echo get_field( 'header_menu_background_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_menu_link_colors', 'option' ) ) : ?>
.king-cat-list li a {
	color:<?php echo get_field( 'header_menu_link_colors', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_menu_link_hover_colors', 'option' ) ) : ?>
.king-cat-list li a:hover {
	color:<?php echo get_field( 'header_menu_link_hover_colors', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_link_color', 'option' ) ) : ?>
.king-head-nav a, .king-cat-dots, .search-close, .king-head-nav .king-head-nav-a {
	color:<?php echo get_field( 'header_link_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'header_search_background', 'option' ) ) : ?>
.king-search-top .header-search-form {
	background-color:<?php echo get_field( 'header_search_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'small_navigation_background', 'option' ) ) : ?>
.king-3rd-nav span {
	background-color:<?php echo get_field( 'small_navigation_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'small_navigation_links', 'option' ) ) : ?>
.king-3rd-nav a {
	color:<?php echo get_field( 'small_navigation_links', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'small_navigation_links_hover', 'option' ) ) : ?>
.king-3rd-nav .active, .king-3rd-nav a:hover {
	background-color:<?php echo get_field( 'small_navigation_links_hover', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_news', 'option' ) ) : ?>
.term-post-format-quote .page-top-header {
	background-color:<?php echo get_field( 'color_for_news', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_news', 'option' ) ) : ?>
.nav-news i{
	color:<?php echo get_field( 'color_for_news', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_videos', 'option' ) ) : ?>
.term-post-format-video .page-top-header {
	background-color:<?php echo get_field( 'color_for_videos', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_videos', 'option' ) ) : ?>
.nav-video i {
	color:<?php echo get_field( 'color_for_videos', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_images', 'option' ) ) : ?>
.term-post-format-image .page-top-header {
	background-color:<?php echo get_field( 'color_for_images', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_images', 'option' ) ) : ?>
.nav-image i{
	color:<?php echo get_field( 'color_for_images', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_music', 'option' ) ) : ?>
.term-post-format-audio .page-top-header {
	background-color:<?php echo get_field( 'color_for_music', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_music', 'option' ) ) : ?>
.nav-music i {
	color:<?php echo get_field( 'color_for_music', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_list', 'option' ) ) : ?>
.post-type-archive-list .page-top-header {
	background-color:<?php echo get_field( 'color_for_list', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_list', 'option' ) ) : ?>
.nav-list i {
	color:<?php echo get_field( 'color_for_list', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_poll', 'option' ) ) : ?>
.post-type-archive-poll .page-top-header {
	background-color:<?php echo get_field( 'color_for_poll', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_poll', 'option' ) ) : ?>
.nav-poll i {
	color:<?php echo get_field( 'color_for_poll', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_trivia_quiz', 'option' ) ) : ?>
.post-type-archive-trivia .page-top-header {
	background-color:<?php echo get_field( 'color_for_trivia_quiz', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'color_for_trivia_quiz', 'option' ) ) : ?>
.nav-trivia i {
	color:<?php echo get_field( 'color_for_trivia_quiz', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'submit_background', 'option' ) ) : ?>
.king-submit-open, .king-submit-drop {
	background-color:<?php echo get_field( 'submit_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'submit_background', 'option' ) ) : ?>
.king-submit-drop:before{
	border-bottom-color:<?php echo get_field( 'submit_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'submit_background', 'option' ) ) : ?>
.king-submit.open .king-submit-open {
	box-shadow: 0px 0px 2px 5px <?php echo get_field( 'submit_background', 'option' ); ?>50;
}
<?php endif; ?>
<?php if ( get_field( 'submiticon_color', 'option' ) ) : ?>	
.king-submit-open, .king-submit-buttons li a i {
	color:<?php echo get_field( 'submiticon_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'submit_button_link_colors', 'option' ) ) : ?>
.king-submit-buttons li a {
	color:<?php echo get_field( 'submit_button_link_colors', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'notification_icon_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'notification_icon_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'notification_icon_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'notification_icon_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'notification_box_background', 'option' ) ) : ?>
.king-notify-menu {
	background-color:<?php echo get_field( 'notification_box_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'notification_box_background', 'option' ) ) : ?>
.king-notify-menu:before {
	border-bottom-color:<?php echo get_field( 'notification_box_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'notification_box_inside_background', 'option' ) ) : ?>
.king-notify-inside {
	background-color:<?php echo get_field( 'notification_box_inside_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'notifications_text_color', 'option' ) ) : ?>
.king-notify-inside li a, 
.king-notify-inside li {
	color:<?php echo get_field( 'notifications_text_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'user_points_badge_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'user_points_badge_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'user_points_badge_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'user_points_badge_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'navigation_links', 'option' ) ) : ?>
.header-nav a {
	color:<?php echo get_field( 'navigation_links', 'option' ); ?>;	
}
...
.header-nav .current-menu-item:before {
	background-color: <?php echo get_field( 'navigation_links_active', 'option' ); ?>;
}
.header-nav .current-menu-item a {
	color: <?php echo get_field( 'navigation_links_active', 'option' ); ?>;
}
.header-nav a:after {
	background-color: <?php echo get_field( 'navigation_links_active', 'option' ); ?>;
}
...
.featured-video video {
	height:<?php echo get_field( 'slider_height', 'option' ); ?>px;
}
...
.editorschoice-height {
	height:<?php echo get_field( 'mini_slider_post_height', 'option' ); ?>px;
}
.editorschoice-height-up {
	min-height:<?php echo get_field( 'mini_slider_post_height', 'option' ); ?>px;
}
<?php endif; ?>
<?php if ( get_field( 'mini_slider_paddings', 'option' ) ) : ?>
.king-editorschoice {
	padding:0 <?php echo get_field( 'mini_slider_paddings', 'option' ); ?>px;
}
<?php endif; ?>
<?php endif; ?>
...
<?php if ( get_field( 'page_header_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'page_header_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'page_header_text_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'page_header_text_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'login_and_register_buttons_background', 'option' ) ) : ?>
.king-login-buttons a {
	background-color:<?php echo get_field( 'login_and_register_buttons_background', 'option' ); ?>;
}
<?php endif; ?>
<?php
$htopt = get_field( 'header_options_top', 'options' );
$hero = $htopt['header_03_options'];
...
<?php
$htopt = get_field( 'header_options_top', 'options' );
$leftmenu = $htopt['header_09_options'];
...
<?php if ( get_field( 'gallery_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'gallery_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'gallery_text_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'gallery_text_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
...
<?php if ( get_field( 'bookmarks_icon_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'bookmarks_icon_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'bookmarks_icon_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'bookmarks_icon_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
...
<?php if ( get_field( 'search_v2_button_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'search_v2_button_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'search_v2_icon_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'search_v2_icon_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'search_v2_box_background', 'option' ) ) : ?>
.live-king-search-top {
	background-color: <?php echo get_field( 'search_v2_box_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'search_v2_input_background', 'option' ) ) : ?>
.live-king-search {
	background-color: <?php echo get_field( 'search_v2_input_background', 'option' ); ?>;
}
<?php endif; ?>
...
.king-grid-17 .king-post-item {
	padding-left: <?php echo get_field( 'padding_between_posts', 'option' ); ?>px;
	padding-right: <?php echo get_field( 'padding_between_posts', 'option' ); ?>px;
...
.king-grid-17 .king-posts {
	margin-left: -<?php echo get_field( 'padding_between_posts', 'option' ); ?>px;
	margin-right: -<?php echo get_field( 'padding_between_posts', 'option' ); ?>px;
}
<?php endif; ?>
...
.king-grid-10 .site-main-top .entry-image-link {
	border-radius: <?php echo get_field( 'border_radius_of_posts', 'option' ); ?>px;
}
.king-grid-17 .entry-image {
	border-radius: <?php echo get_field( 'border_radius_of_posts', 'option' ); ?>px <?php echo get_field( 'border_radius_of_posts', 'option' ); ?>px 0 0;
}
...
.king-featured-grid {
	column-gap: <?php echo get_field( 'padding_between_grid_posts', 'option' ); ?>px;
	row-gap: <?php echo get_field( 'padding_between_grid_posts', 'option' ); ?>px;
}
<?php endif; ?>
<?php if ( get_field( 'border_radius_of_grid_posts', 'option' ) || '0' === get_field( 'border_radius_of_grid_posts', 'option' ) ) : ?>
.king-featured-grid .featured-posts > a {
	border-radius: <?php echo get_field( 'border_radius_of_grid_posts', 'option' ); ?>px;
}
<?php endif; ?>
/* ------footer------ */
...
<?php if ( get_field( 'footer_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'footer_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'footer_text_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'footer_text_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'fatfooter_background', 'option' ) ) : ?>
.fatfooter {
	background-color:<?php echo get_field( 'fatfooter_background', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'footer_widgets_title_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'footer_widgets_title_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'footer_widgets_title_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'footer_widgets_title_color', 'option' ); ?>;
	border-color:<?php echo get_field( 'footer_widgets_title_color', 'option' ); ?>;<?php endif; ?>		
}
<?php endif; ?>
<?php if ( get_field( 'footer_link_color', 'option' ) ) : ?>
.site-footer a {
	color:<?php echo get_field( 'footer_link_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'footer_links_hover', 'option' ) ) : ?>
.site-footer a:hover {
	color:<?php echo get_field( 'footer_links_hover', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'alert_background_color', 'option' ) || get_field( 'alert_text_color', 'option' ) ) : ?>
.king-alert-like {
<?php if ( get_field( 'alert_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'alert_text_color', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'alert_background_color', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'alert_background_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
/* ------sidebar------ */
<?php if ( get_field( 'sidebar_text_color', 'option' ) ) : ?>
.first-sidebar ul li {
	color:<?php echo get_field( 'sidebar_text_color', 'option' ); ?>;
}
<?php endif; ?>

<?php if ( get_field( 'sidebar_links', 'option' ) ) : ?>
.first-sidebar ul li a {
	color:<?php echo get_field( 'sidebar_links', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'sidebar_widgets_title_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'sidebar_widgets_title_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'sidebar_widgets_title_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'sidebar_widgets_title_color', 'option' ); ?>;<?php endif; ?>	
}
<?php endif; ?>
<?php if ( get_field( 'sidebar_posts_background', 'option' ) ) : ?>
.king-simple-post {
	background-color:<?php echo get_field( 'sidebar_posts_background', 'option' ); ?>;
}
<?php endif; ?>
...
.entry-meta .post-views i, .entry-meta .post-comments i, .entry-meta .post-time i, .entry-meta .post-likes i {
	color:<?php echo get_field( 'sidebar_widgets_post_meta_text_color', 'option' ); ?>!important;
}
<?php endif; ?>
/* ------PostPage------ */
<?php if ( get_field( 'font_size_in_post_page', 'option' ) ) : ?>
.post-page .hentry {
	font-size:<?php echo get_field( 'font_size_in_post_page', 'option' ); ?>px;
...
<?php if ( get_field( 'post_content_background_color', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'post_content_background_color', 'option' ); ?>;<?php endif; ?>
	<?php if ( get_field( 'post_content_text_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'post_content_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'post_content_text_color', 'option' ) ) : ?>
.tags-links a {
	color:<?php echo get_field( 'post_content_text_color', 'option' ); ?>;
	border-color: <?php echo get_field( 'post_content_text_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'post_author_box_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'post_author_box_background', 'option' ); ?>;<?php endif; ?>
	<?php if ( get_field( 'post_author_box_text_color', 'option' ) ) : ?>	
	color:<?php echo get_field( 'post_author_box_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'post_author_box_text_color', 'option' ) ) : ?>
.post-author-name {
	color:<?php echo get_field( 'post_author_box_text_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'post_meta_background', 'option' ) ) : ?>
.single-post .post-meta {
	background-color:<?php echo get_field( 'post_meta_background', 'option' ); ?>;
}
<?php endif; ?>
...
.single-post .post-views i, .single-post .post-comments i, .single-post .post-time i, .single-post .post-likes i {
	color:<?php echo get_field( 'post_meta_text_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'editors_choice_badge_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'editors_choice_badge_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'editors_choice_badge_text', 'option' ) ) : ?>
	color:<?php echo get_field( 'editors_choice_badge_text', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'post_buttons_border', 'option' ) || get_field( 'post_buttons_color', 'option' ) ) : ?>
.kingp-bttns {
<?php if ( get_field( 'post_buttons_border', 'option' ) ) : ?>
	border-color:<?php echo get_field( 'post_buttons_border', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'post_buttons_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'post_buttons_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>

<?php if ( get_field( 'poll_results_background_color', 'option' ) ) : ?>
.voted .king-poll-result {
	background-color: <?php echo get_field( 'poll_results_background_color', 'option' ); ?>;
	opacity:.6;
}
<?php endif; ?>
<?php if ( get_field( 'poll_user_choice_background', 'option' ) ) : ?>
.king-poll-answer.vote {
	border-color: <?php echo get_field( 'poll_user_choice_background', 'option' ); ?>;
}
.voted .king-poll-answer.vote .king-poll-result {
	background-color: <?php echo get_field( 'poll_user_choice_background', 'option' ); ?>;
	opacity:.6;
}
<?php endif; ?>
<?php if ( get_field( 'triviaquiz_correct_answer_background', 'option' ) ) : ?>
.king-quiz-answer.correct .king-poll-answer-in {
	background-color: <?php echo get_field( 'triviaquiz_correct_answer_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'triviaquiz_wrong_answer_background', 'option' ) ) : ?>
.king-quiz-answer.not-correct .king-poll-answer-in {
	background-color: <?php echo get_field( 'triviaquiz_wrong_answer_background', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'post_share_button_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'post_share_button_background', 'option' ); ?>;
	border-color:<?php echo get_field( 'post_share_button_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'post_share_button_icon_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'post_share_button_icon_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
...
<?php if ( get_field( 'vote_count_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'vote_count_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'vote_count_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'vote_count_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'vote_icons_color', 'option' ) ) : ?>
.king-vote-icon {
	color:<?php echo get_field( 'vote_icons_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'next-prev_posts_bars_background', 'option' ) ) : ?>
.post-nav-np {
	background-color:<?php echo get_field( 'next-prev_posts_bars_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'next-prev_posts_bars_text_color', 'option' ) ) : ?>
.post-nav-np a {
	color:<?php echo get_field( 'next-prev_posts_bars_text_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'comments_area_background_color', 'option' ) ) : ?>
.comments-area {
	background-color:<?php echo get_field( 'comments_area_background_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'comment_box_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'comment_box_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'comment_box_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'comment_box_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'comment_box_text_color', 'option' ) ) : ?>
#comments .user-header-settings cite, .comment-meta time {
	color:<?php echo get_field( 'comment_box_text_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'comments_reply_button_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'comments_reply_button_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'comments_reply_button_value_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'comments_reply_button_value_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
...
<?php if ( get_field( 'comment_form_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'comment_form_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'comment_form_text_color', 'option' ) ) : ?>
	color:<?php echo get_field( 'comment_form_text_color', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'post_page_boxes_background', 'option' ) ) : ?>
.single-boxes {
	background-color: <?php echo get_field( 'post_page_boxes_background', 'option' ); ?>;
}	
<?php endif; ?>
<?php if ( get_field( 'post_page_boxes_title_background', 'option' ) ) : ?>
.single-boxes-title {
	background-color: <?php echo get_field( 'post_page_boxes_title_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'post_page_boxes_title_color', 'option' ) ) : ?>
.single-boxes-title h4 {
	color: <?php echo get_field( 'post_page_boxes_title_color', 'option' ); ?>;
}
<?php endif; ?>
/* ------KingflixPage------ */
<?php if ( get_field( 'kingflix_categories_title_color', 'option' ) ) : ?>
.kingflix-head a {
	color:<?php echo get_field( 'kingflix_categories_title_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'kingflix_posts_background', 'option' ) ) : ?>
.kingflix-post-content {
	background-color:<?php echo get_field( 'kingflix_posts_background', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'kingflix_posts_title_color', 'option' ) ) : ?>
.kingflix-post-title a,
.king-editorschoice-title {
	color:<?php echo get_field( 'kingflix_posts_title_color', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'kingflix_post_buttons_colors', 'option' ) ) : ?>
.kingflix-button {
	color:<?php echo get_field( 'kingflix_post_buttons_colors', 'option' ); ?>;
	border-color:<?php echo get_field( 'kingflix_post_buttons_colors', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'kingflix_post_meta_color', 'option' ) ) : ?>
.kingflix-post-in .cat-links a {
	color:<?php echo get_field( 'kingflix_post_meta_color', 'option' ); ?>;
}
<?php endif; ?>
...
<?php if ( get_field( 'quick_view_background', 'option' ) ) : ?>
	background-color:<?php echo get_field( 'quick_view_background', 'option' ); ?>;<?php endif; ?>
<?php if ( get_field( 'quick_view_post_content', 'option' ) ) : ?>
	color:<?php echo get_field( 'quick_view_post_content', 'option' ); ?>;<?php endif; ?>
}
<?php endif; ?>
<?php if ( get_field( 'quick_view_post_title', 'option' ) ) : ?>
.mfp-content .entry-header {
	color:<?php echo get_field( 'quick_view_post_title', 'option' ); ?>;
}
<?php endif; ?>
<?php if ( get_field( 'quick_view_widget_title', 'option' ) ) : ?>
.mfp-content .king-related .related-title {
	color:<?php echo get_field( 'quick_view_widget_title', 'option' ); ?>;
}
<?php endif; ?>
...
.lr-padding {
	padding-left: <?php echo get_field( 'left_right_padding', 'option' ); ?>%;
	padding-right: <?php echo get_field( 'left_right_padding', 'option' ); ?>%;
}
.king-nav-dropdown {
	left: <?php echo get_field( 'left_right_padding', 'option' ); ?>%;
	right: <?php echo get_field( 'left_right_padding', 'option' ); ?>%;
}
<?php endif; ?>
<?php if ( get_field( 'left_right_padding_sider', 'option' ) || '0' === get_field( 'left_right_padding_sider', 'option' ) ) : ?>
.king-featured-top {
	padding-left: <?php echo get_field( 'left_right_padding_sider', 'option' ); ?>%;
	padding-right: <?php echo get_field( 'left_right_padding_sider', 'option' ); ?>%;
}
