...
<div class="social-login">
	...
	<?php if ( get_field( 'enable_twitter_login', 'option' ) ) : ?>
		<a class="twi-login" href="<?php echo esc_url( site_url() . '/' . $GLOBALS['king_login'] . '/Twitter' ); ?>"><i class="fab fa-x-twitter"></i><?php esc_html_e( 'Connect w/', 'king' ); ?> <b><?php esc_html_e( 'X', 'king' ); ?></b></a>
	<?php endif; ?>	
