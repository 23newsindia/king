...
<?php if ( get_field( 'enable_headerstrip', 'options' ) ) : ?>
	...
	<div class="king-headerstrip" data-headerstrip="<?php echo get_field( 'hs_expired_time', 'options' ); ?>" id="hs-<?php echo get_field( 'hs_expired_time', 'options' ); ?>" style="display: none;">
		<div class="king-hs-content">
			<?php echo get_field( 'headerstrip_text', 'options' ); ?>
			<?php if ( get_field( 'headerstrip_button_url', 'options' ) && get_field( 'headerstrip_button_text', 'options' ) ) : ?>
				<a href="<?php echo get_field( 'headerstrip_button_url', 'options' ); ?>" class="king-hs-button"><?php echo get_field( 'headerstrip_button_text', 'options' ); ?></a>
			<?php endif; ?>
		</div>
