	...
	<?php else : ?>
		<?php if ( get_field( 'custom_message_register', 'options' ) ) : ?>
			<div class="king-custom-message">
				<?php echo get_field( 'custom_message_register', 'options' ); ?>
			</div>
		<?php endif; ?>	
	<form action="" id="register-form" method="post">
		...
		<?php if ( get_field( 'enable_terms_and_conditions', 'options' ) ) : ?>	
			<div class="king-form-group">
				...
				<?php } ?>
				<div class="terms-cond"> <?php echo get_field( 'terms_and_conditions', 'options' ); ?> </div>
			</div>
		<?php endif; ?>	
		<?php if ( get_field( 'enable_recaptcha', 'options' ) ) : ?>
			<div class="king-form-group">
				<div class="g-recaptcha" data-sitekey="<?php echo get_field( 'recaptcha_key', 'options' ); ?>"></div>
