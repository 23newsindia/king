		...
		public function king_demo_data() {
			...
			return array(
				...
				array(
					...
					'preview_url'              => 'https://wp.kingthemes.net/main',
				),
				/* blog */
				array(
					'id'                       => 'blog',
					'import_file_name'         => esc_html__( 'Blog Demo', 'king' ),
					'import_file_url'          => sprintf( '%1$s/blog/king-demo-content.xml', $king_url ),
					'options'                  => sprintf( '%1$s/blog/options.json', $king_url ),
					'import_preview_image_url' => sprintf( '%1$s/blog/screenshot.png', $king_url ),
					'import_notice'            => sprintf( '<strong>%1$s</strong>%2$s', esc_html__( 'Blog', 'king' ), $import_note ),
					'preview_url'              => 'https://wp.kingthemes.net/blog/',
				),				
				/* music */
				array(
					'id'                       => 'music',
					'import_file_name'         => esc_html__( 'Music Demo', 'king' ),
					'import_file_url'          => sprintf( '%1$s/music/king-demo-content.xml', $king_url ),
					'options'                  => sprintf( '%1$s/music/options.json', $king_url ),
					'import_preview_image_url' => sprintf( '%1$s/music/screenshot.png', $king_url ),
					'import_notice'            => sprintf( '<strong>%1$s</strong>%2$s', esc_html__( 'Music', 'king' ), $import_note ),
					'preview_url'              => 'https://wp.kingthemes.net/music/',
				),
				/* pin */
				array(
					'id'                       => 'pin',
				...
				array(
					...
					'preview_url'              => 'https://wp.kingthemes.net/insta2/',
				),
				/* magazine */
				array(
					'id'                       => 'magazine',
				...
				array(
					...
					'preview_url'              => 'https://wp.kingthemes.net/kingflix/',
				),
				/* KingTube */
				array(
					'id'                       => 'kingtube',
					...
					'preview_url'              => 'https://wp.kingthemes.net/kingtube/',
				),
				/* Dark */
				array(
					'id'                       => 'dark',
					...
					'preview_url'              => 'https://wp.kingthemes.net/dark',
				),
				/* DesignKing */
				array(
					'id'                       => 'designking',
					...
					'preview_url'              => 'https://wp.kingthemes.net/designking',
				),
				/* Castle */
				array(
					'id'                       => 'castle',
					...
					'preview_url'              => 'https://wp.kingthemes.net/castle',
				),
				/* Masonry */
				array(
					'id'                       => 'masonry',
					...
					'preview_url'              => 'https://wp.kingthemes.net/masonry',
				),
				/* Boxed */
				array(
					'id'                       => 'boxed',
					...
					'preview_url'              => 'https://wp.kingthemes.net/boxed',
				),
				/* Kingstagram */
				array(
					'id'                       => 'kingstagram',
				...
				array(
					...
					'preview_url'              => 'https://wp.kingthemes.net/crown',
				),
				/* Prince */
				array(
					'id'                       => 'prince',
				...
				array(
					...
					'preview_url'              => 'https://wp.kingthemes.net/viking',
				),
			);
