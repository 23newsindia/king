...
?>
<aside id="king-newsletter" class="king-newsletter" data-expired="<?php echo get_field( 'newsletter_expired', 'options' ); ?>" data-delay="<?php echo get_field( 'newsletter_delay_time', 'options' ); ?>" data-id="newsl-<?php echo get_field( 'newsletter_delay_time', 'options' ); ?>" style="display: none;">
	<div class="king-newsletter-popup">
		<div class="king-newsletter-content">
			...
			<?php if ( get_field( 'newsletter_description', 'options' ) ) : ?>
				<div class="king-newsletter-desc"><p><?php echo get_field( 'newsletter_description', 'options' ); ?></p></div>
			<?php endif; ?>
			...
			<?php if ( get_field( 'newsletter_submit_text', 'options' ) ) : ?>
				<button type="submit" name="submit" class="newsletter-submit"><?php echo get_field( 'newsletter_submit_text', 'options' ); ?></button>
			<?php endif; ?>	
				</div>
				...
				<div class="king-newsletter-privacy">
					...
					<label for="king-privacy"><?php echo get_field( 'privacy_text', 'options' ); ?></label>
				</div>
				<?php endif; ?>	
			</form>
