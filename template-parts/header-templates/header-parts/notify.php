...
<div class="king-notify">
	...
	<div class="king-notify-box <?php echo esc_attr( $flagc ); ?>" id="flagbox">
		<div class="king-notify-toggle head-icons" id="ftoggle" data-toggle="dropdown" data-target="#flagmenu" aria-expanded="true"><i class="far fa-flag"></i><span class="king-notify-num"><?php echo esc_attr( $flag ); ?></span></div>
...
<div class="king-notify">
	...
	<div class="king-notify-box <?php echo esc_attr( $notifyclass ); ?>" id="notifybox">
		<div class="head-icons" id="ntoggle" data-toggle="dropdown" data-target="#notifymenu" aria-expanded="true"><i class="far fa-bell fa-lg"></i><span class="king-notify-num"><?php echo esc_attr( $notify ); ?></span></div>
