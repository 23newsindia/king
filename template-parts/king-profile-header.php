			...
			<div class="king-profile-avatar">
				...
				if ( get_field( 'author_image', 'user_' . $user_id ) ) :
					...
					<?php if ( function_exists( 'is_woocommerce' ) && get_field( 'enable_membership', 'options' ) && king_check_membership( null, $user_id ) === true && ! $profile_id ) : ?>
						<a data-toggle="tooltip" data-placement="top" title="<?php echo get_field( 'membership_icon_title', 'option' ); ?>" class="membership-link" href="<?php echo esc_url( add_query_arg( array( 'template' => 'myplan' ), site_url() . '/' . $GLOBALS['king_dashboard'] ) ); ?>" ><?php echo get_field( 'membership_icon', 'options' ); ?></a>
					<?php elseif ( function_exists( 'is_woocommerce' ) && get_field( 'enable_membership', 'options' ) && king_check_membership( null, $user_id ) === true && $profile_id ) : ?>
						<span data-toggle="tooltip" data-placement="top" title="<?php echo get_field( 'membership_icon_title', 'option' ); ?>" class="membership-link" ><?php echo get_field( 'membership_icon', 'options' ); ?></span>
					<?php endif; ?>
					<?php if ( $url ) : ?>
					</a>
				<?php endif; ?>
			...
			<div class="king-profile-social">
				<ul>
					...
					<?php if ( get_field( 'profile_facebook', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'facebook', 'king' ); ?>" class="fb"><a href="<?php echo get_field( 'profile_facebook', 'user_' . $user_id ); ?>" target="_blank"><i class="fab fa-facebook"></i></a></li>
					<?php endif; ?>
					<?php if ( get_field( 'profile_twitter', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'X', 'king' ); ?>" class="twi"><a href="<?php echo get_field( 'profile_twitter', 'user_' . $user_id ); ?>" target="_blank"><i class="fab fa-x-twitter"></i></a></li>
					<?php endif; ?>
					<?php if ( get_field( 'profile_instagram', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'instagram', 'king' ); ?>" class="g"><a href="<?php echo get_field( 'profile_instagram', 'user_' . $user_id ); ?>" target="_blank"><i class="fab fa-instagram"></i> </a></li>
					<?php endif; ?>
					<?php if ( get_field( 'profile_pinterest', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'pinterest', 'king' ); ?>" class="g"><a href="<?php echo get_field( 'profile_pinterest', 'user_' . $user_id ); ?>" target="_blank"><i class="fab fa-pinterest-p"></i> </a></li>
					<?php endif; ?>
					<?php if ( get_field( 'profile_linkedin', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'linkedin', 'king' ); ?>" class="ln"><a href="<?php echo get_field( 'profile_linkedin', 'user_' . $user_id ); ?>" target="_blank"><i class="fab fa-linkedin"></i></a></li>
					<?php endif; ?>        
					<?php if ( get_field( 'profile_add_url', 'user_' . $user_id ) ) : ?>
						<li data-toggle="tooltip" data-placement="left" title="<?php echo esc_html_e( 'url', 'king' ); ?>" class="ln"><a href="<?php echo get_field( 'profile_add_url', 'user_' . $user_id ); ?>" target="_blank"><i class="fas fa-link"></i></a></li>
					<?php endif; ?> 				    
				</ul>
			</div>
