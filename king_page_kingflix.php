	...
	<main id="main" class="site-main full-width">
		<div class="king-kingflix-page">
				...
				if ( $rlposts ) :
					...
					<div class="kingflix-blocks">
						<div class="kingflix-head">
							<h4 class="king-editorschoice-title"><?php echo wp_kses_post( get_field( 'kingflix_bookmarked_posts_header' ) ); ?></h4>
						</div>
			...
			<?php if ( get_field( 'kingflix_display_trending_posts' ) ) : ?>
				<div class="kingflix-blocks">
					<div class="kingflix-head">
						<h4 class="king-editorschoice-title"><?php echo wp_kses_post( get_field( 'kingflix_trending_posts_header' ) ); ?></h4>
					</div>
					<div class="kingflix-posts owl-carousel">
						<?php
						$featured = get_posts(
