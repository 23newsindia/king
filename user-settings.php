...
<div class="king-form-group">
		...
		<input type="text" id="facebook-edit" class="bpinput" name="facebook-edit" value="<?php echo get_field( 'profile_facebook', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>

<div class="king-form-group">
		<label for="twitter-edit"><?php esc_attr_e( 'X', 'king' ); ?></label>
		<input type="text" id="twitter-edit" class="bpinput" name="twitter-edit" value="<?php echo get_field( 'profile_twitter', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>

<div class="king-form-group">
    <label for="instagram-edit"><?php esc_attr_e( 'instagram', 'king' ); ?></label>
    <input type="text" id="instagram-edit" class="bpinput" name="instagram-edit" value="<?php echo get_field( 'profile_instagram', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>

<div class="king-form-group">
    <label for="pinterest-edit"><?php esc_attr_e( 'pinterest', 'king' ); ?></label>
    <input type="text" id="pinterest-edit" class="bpinput" name="pinterest-edit" value="<?php echo get_field( 'profile_pinterest', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>


<div class="king-form-group">
		<label for="linkedin-edit"><?php esc_attr_e( 'linkedin', 'king' ); ?></label>
		<input type="text" id="linkedin-edit" class="bpinput" name="linkedin-edit" value="<?php echo get_field( 'profile_linkedin', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>
<div class="king-form-group">
		<label for="customurl-edit"><?php esc_attr_e( 'Url', 'king' ); ?></label>
		<input type="text" id="customurl-edit" class="bpinput" name="customurl-edit" value="<?php echo get_field( 'profile_add_url', 'user_' . $this_user->ID ); ?>" maxlength="140">
</div>
