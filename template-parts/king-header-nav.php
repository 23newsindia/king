...
<?php endif; ?>
	...
	<?php if ( king_plugin_active( 'WooCommerce' ) && ( ! get_field( 'enable_membership', 'options' ) || get_field( 'display_cart_icon', 'options' ) ) ) : ?>
		...
		<div class="king-cart">
			<button class="king-cart-toggle" data-toggle="modal" data-target=".king-cart-content" aria-expanded="false" aria-label="View cart">
			...
			<div class="king-cart-content">
				<button type="button" class="king-cart-close" data-dismiss="modal" aria-label="Close cart">
