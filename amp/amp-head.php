...
<?php if ( get_field( 'amp_body_background_color', 'option' ) ) : ?>
	background-color: <?php echo get_field( 'amp_body_background_color', 'option' ); ?>;
<?php else : ?>
...
<?php if ( get_field( 'amp_container_text_color', 'option' ) ) : ?>
	color: <?php echo get_field( 'amp_container_text_color', 'option' ); ?>;
<?php else : ?>
	color: #666;
<?php endif; ?>		
	}
...
<?php if ( get_field( 'amp_header_background', 'option' ) ) : ?>
	background-color:  <?php echo get_field( 'amp_header_background', 'option' ); ?>;
<?php else : ?>
	background-color: #ffffff;
<?php endif; ?>
	text-align:center;
...
<?php if ( get_field( 'amp_container_background', 'option' ) ) : ?>
	background-color:  <?php echo get_field( 'amp_container_background', 'option' ); ?>;
<?php else : ?>
	background-color: #ffffff;
<?php endif; ?>	
	padding:10px 0;
...
<?php if ( get_field( 'amp_share_box_background', 'option' ) ) : ?>
	background-color:  <?php echo get_field( 'amp_share_box_background', 'option' ); ?>;
<?php else : ?>
	background-color: #ffffff;
<?php endif; ?>	
    border-radius: 8px;
...
<?php if ( get_field( 'amp_custom_css', 'option' ) ) : ?>
	<?php echo get_field( 'amp_custom_css', 'option' ); ?>
<?php endif; ?>
</style>