...
if ( isset( $_POST['king_edit_post_upload_form_submitted'] ) && wp_verify_nonce( $_POST['king_edit_post_upload_form_submitted'], 'king_edit_post_upload_form' ) ) { // input var okay; sanitization okay.
	...
	if ( $format === 'video' ) {
		...
		if ( isset( $_POST['acf']['field_654bf17128933'] ) ) {
			$video_url = esc_url( wp_unslash( $_POST['acf']['field_654bf17128933'] ) ); // Input var okey.
		}
		...
		<form id="king_posts_form" action="" method="POST" enctype="multipart/form-data">
			<div class="submit-news-left">
				<div class="king-form-group">
					...
					<input class="form-control bpinput" name="king_post_title" id="king_post_title" type="text" value="<?php echo esc_attr( $title ); ?>" maxlength="<?php echo get_field( 'maximum_title_length', 'option' ); ?>" required />
				</div>
			...
			<div class="king-repeater">
				...
				acf_form(
					array(
						...
						'return'   => '',
						'uploader' => false,
						'fields'   => array( 'field_654ad532f1f24', 'field_654bf17128933', 'field_654ad5b1f1f25', 'field_654bf1aa28934' ),
					)
				);
				...
				<?php
					acf_form(
						array(
							...
							'return'   => '',
							'uploader' => false,
							'field_groups' => array( 'group_654ad532a86fb' ),
						)
					);
				?>
			</div>
